...
const Register = () => {
  return (
    <div className="py-10 flex justify-center">
      <div className="max-w-[700px] lg:max-w-[1600px] flex rounded-[50px] min-h-[310px]  md:h-[500px] lg:h-full w-full bg-[#37445a] px-5 md:px-10 pt-10 relative overflow-hidden  mx-5 md:mx-10">
