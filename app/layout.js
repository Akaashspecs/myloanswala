...
export const metadata = {
  title: "MyLoanswala - Loans Made Easy",
  description:
  ...
  icons: {
    icon: [
      { url: "/favv.ico" },
      { url: "/MyLoanswala-Logo.png", type: "image/png", sizes: "32x32" },
      { url: "/MyLoanswala-Logo.png", type: "image/png", sizes: "192x192" },
    ],
    apple: [
      { url: "/MyLoanswala-Logo.png", sizes: "180x180", type: "image/png" },
    ],
  },
};
